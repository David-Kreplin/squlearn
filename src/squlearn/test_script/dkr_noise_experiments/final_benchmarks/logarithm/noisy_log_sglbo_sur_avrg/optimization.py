...
optimizer_options = {"tol":0.0, "bo_aqc_func": "EI", "bo_aqc_optimizer": "lbfgs", "bo_bounds": [(-1e-3, 0.2)], "log_file": "/data/sglbo_log_noise_sur_avrg.log",
                     "bo_n_calls": 60, "bo_x0_points": x0, "maxiter": 300, "min_surrogate":True, "num_average":3 }
